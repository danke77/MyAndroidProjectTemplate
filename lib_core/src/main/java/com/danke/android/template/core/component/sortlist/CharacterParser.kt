 ...
 * @date 2018/7/23
 */
class CharacterParser private constructor() {

    companion object {

        private val UNKNOWN_TAG = "unknown"

        private val PY_VALUE = intArrayOf(
        ...
        private val PY_STR = arrayOf(
                ...
                "ji", "jia", "jian", "jiang", "jiao", "jie", "jin",
                "jing", "jiong", "jiu", "ju", "juan", "jue", "jun",
                ...
                "shao", "she", "shen", "sheng", "shi", "shou", "shu", "shua", "shuai", "shuan", "shuang",
                ...
                "xi", "xia", "xian", "xiang", "xiao", "xie", "xin",
                ...
                "zhai", "zhan", "zhang", "zhao", "zhe", "zhen", "zheng", "zhi",
                "zhong", "zhou", "zhu", "zhua", "zhuai", "zhuan", "zhuang", "zhui",
                "zhun", "zhuo", "zi", "zong", "zou", "zu", "zuan", "zui", "zun", "zuo"
        )

        private val INSTANCE = CharacterParser()

        @JvmStatic
        fun getInstance(): CharacterParser {
            return INSTANCE
        }
    ...
    fun convert(str: String): String? {
        ...
        if (ascii in 1..159) {
            ...
            for (i in PY_VALUE.size - 1 downTo 0) {
                if (PY_VALUE[i] <= ascii) {
                    result = PY_STR[i]
                    break
                }
    ...
    fun getSelling(chs: String): String? {
        var key: String
        var value: String?
